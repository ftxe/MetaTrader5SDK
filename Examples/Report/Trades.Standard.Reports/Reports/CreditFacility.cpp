...
//| Report generation                                                |
//+------------------------------------------------------------------+
MTAPIRES CCreditFacility::Generate(const UINT type,IMTReportAPI *api)
  {
   UINT64  *logins=NULL;
   UINT     logins_total=0;
   MTAPIRES res;
...
//| Write table                                                      |
//+------------------------------------------------------------------+
MTAPIRES CCreditFacility::TableWrite(const UINT64 login)
  {
   UINT          deal_total,i;
   IMTDeal      *deal;
...
//| Sort summary                                                     |
//+------------------------------------------------------------------+
int CCreditFacility::SortSummary(const void *left,const void *right)
  {
