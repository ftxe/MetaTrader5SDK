...
//| Report generation                                                |
//+------------------------------------------------------------------+
MTAPIRES CStopOutCompensation::Generate(const UINT type,IMTReportAPI *api)
  {
   UINT64  *logins=NULL;
   UINT     logins_total=0;
   MTAPIRES res;
...
//+------------------------------------------------------------------+
MTAPIRES CStopOutCompensation::TableWrite(const UINT64 login)
  {
   IMTDeal     *deal=NULL;
   UINT         deal_total,i;
...
//| Sort summary                                                     |
//+------------------------------------------------------------------+
int CStopOutCompensation::SortSummary(const void *left,const void *right)
  {
